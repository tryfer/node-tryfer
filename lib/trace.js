...
(function () {
   ...
   * trace, and also does not support flags.
   *
   * @param {String} request_method The method of the request (e.g. GET, POST)
   ...
   *  new, empty {Trace}.
   */
  Trace.fromRequest = function(request_method, request_headers) {
    var self = this;
    var traceOptions = {};
    ...
    return new Trace(request_method, traceOptions);
  };
