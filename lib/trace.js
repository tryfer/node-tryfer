...
(function () {
    ...
    Trace = function(name, options) {
        ...
        process.stdout.write("creating trace with options:"+JSON.stringify(options) + '\n');
    ...
    /**
     * Set a default {Tracer} for the current {Trace}.
     *
     * @param {Array} tracers Array of tracers for this
     *    {Trace}
     */
    Trace.prototype.setTracers = function(tracers){
     ...
     *    values
     * @param {Object} options A mapping of lower-cased header field names to
     *    values
     */
    Trace.fromHeaders = function(traceName, headers, options) {
        var traceOptions = options || {};
        ...
        console.log("creating trace from request: "+JSON.stringify(traceOptions));
     ...
     * @param {Object} options pass in tracers
     */
    Trace.fromRequest = function(request, serviceName, options) {
        var newTrace = Trace.fromHeaders(
            request.method || 'GET', request.headers || options);
