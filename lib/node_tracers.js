...
(function () {
   ...
   */
  module.exports.RawRESTkinHTTPTracer = function(trace_url, keystone_client, options) {
    options = options || {};
    var self = this;
    ...
    self.sendTrace = function(trace, annotations) {
      ...
      if (self._batchMode) {
        ...
        if ((self._queue.length >= self._sendAfterMsgs) || ((self._lastSentTs + self._sendAfterInterval) < now)) {
   ...
   *    defaults to "zipkin" if not passed
   */
  module.exports.RawRESTkinScribeTracer = function (scribe_client, category) {
    var self = this;
    self.scribe_client = scribe_client;
